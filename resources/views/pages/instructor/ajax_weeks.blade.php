@for($i=0; $i<count($weeks); $i++)
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 float-left">
								<div class="add-week-panel ">
									<div class="and-all lesson-add">
										<ul>								
											<li>
												<h4>Lesson. {{ $weeks[$i]->lesson_id}}:</h4>
											</li>
											
											<li>
												<p>{{ $weeks[$i]->lesson_title}}.</p>
											</li>
									...
									<div class="add-lesson-quiz-coding">
										<ul>
											<li class="add-btns"><a href="#" data-toggle="modal" data-target="#add-lesson{{$weeks[$i]->week_id}}">Lesson</a></li>
											...
											<li class="add-btns"><a href="#" data-toggle="modal" data-target="#add-coding{{$weeks[$i]->week_id}}">Conding</a></li>
	...
	<!-- add-lesson-model -->
	<div class="modal fade add-lesson" id="add-lesson{{$weeks[$i]->week_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				...
				<div class="modal-body">
					<div class="add-week-fileds">
						...
						<form id="weekLessonForm" class="about-course" enctype="multipart/form-data">
							...
							<input type="hidden" value="{{$weeks[$i]->week_id}}" id="weekValue" name="weekValue"/>
		...
		<!-- add-condo-model -->
		<div class="modal fade" id="add-coding{{$weeks[$i]->week_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					...
					<div class="modal-body">
						<div class="add-week-fileds">
							...
							<div class="seprator new-sep ">&nbsp;</div>
							<form id="weekCondingForm" class="about-course" enctype="multipart/form-data">
