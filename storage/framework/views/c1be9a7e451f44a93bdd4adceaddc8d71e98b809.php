...
<section id="main-area">
		...
		<div id="outerBankSlider" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
					<img class="img-fluid" src="<?php echo e(asset('public/img/slider-img.png')); ?>" alt="First slide">
					<div class="carousel-caption">
						<div class="tree-img">
							<img src="<?php echo e(asset('public/img/slider-small-img.png')); ?>" alt="">
						</div>
						...
						<div class="slider-center-button">
							<a href="<?php echo e(route('allCourses')); ?>">START FREE TRAIL</a>
						</div>
					</div>
				</div>
				<div class="carousel-item">
					<img class="img-fluid" src="<?php echo e(asset('public/img/slider-img.png')); ?>" alt="Second slide">
					<div class="carousel-caption">
						<div class="tree-img">
							<img src="<?php echo e(asset('public/img/slider-small-img.png')); ?>" alt="">
						</div>
			...
			<div class="icon-area">
				<ul class="oval-icons">
					<li class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
						<a href="#">
							<div class="oval-border"><img src="<?php echo e(asset('public/img/icon-1.png')); ?>" alt="icon-1"></div>
						</a>
						<p class="bottom-name">Courses</p>
					</li>
					<li class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
						<a href="#">
							<div class="oval-border"><img src="<?php echo e(asset('public/img/icon-2.png')); ?>" alt="icon-2"></div>
						</a>
						<p class="bottom-name">Quizzes</p>
					</li>
					<li class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
						<a href="#">
							<div class="oval-border"><img src="<?php echo e(asset('public/img/icon-3.png')); ?>" alt="icon-3"></div>
						</a>
				...
				<ul class="oval-icons">
					<li class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
						<a href="#">
							<div class="oval-border"><img src="<?php echo e(asset('public/img/icon-4.png')); ?>" alt="icon-4"></div>
						</a>
						<p class="bottom-name">Messages</p>
					</li>
					<li class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
						<a href="#">
							<div class="oval-border"><img src="<?php echo e(asset('public/img/icon-5.png')); ?>" alt="icon-5"></div>
						</a>
						<p class="bottom-name">Upload</p>
					</li>
					<li class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
						<a href="#">
							<div class="oval-border"><img src="<?php echo e(asset('public/img/icon-6.png')); ?>" alt="icon-6"></div>
						</a>
	...
	<div class="innovative col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div id="container">
			...
			<div class="tree-big-img">
				<img class="img-fluid" src="<?php echo e(asset('public/img/grey-swahlipro.png')); ?>" alt="">
			</div>
		</div>
	</div>
		...
		<div id="container">
			...
			<ul class="small-icon-area">
				<li class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
					<a href="#">
						<div class="icon-img"><img src="<?php echo e(asset('public/img/triditional-programs-icon-1.png')); ?>" alt="icon-1"></div>
						<h2>LOCAL TRANSPORT</h2>
					</a>
				</li>
				<li class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
					<a href="#">
						<div class="icon-img"><img src="<?php echo e(asset('public/img/triditional-programs-icon-2.png')); ?>" alt="icon-2"></div>
						<h2>CHILDCARE</h2>
					</a>
				</li>
				<li class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
					<a href="#">
						<div class="icon-img"><img src="<?php echo e(asset('public/img/triditional-programs-icon-3.png')); ?>" alt="icon-3"></div>
						<h2>TRAVEL INSURANCE</h2>
					</a>
				</li>
				<li class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
					<a href="#">
						<div class="icon-img"><img src="<?php echo e(asset('public/img/triditional-programs-icon-4.png')); ?>" alt="icon-4"></div>
						<h2>STUDENT VISAS</h2>
					</a>
				</li>
			</ul>
			<ul class="small-icon-area icon-area-newest">
				<li class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
					<a href="#">
						<div class="icon-img"><img src="<?php echo e(asset('public/img/triditional-programs-icon-5.png')); ?>" alt="icon-5"></div>
						<h2>COURSE FEES</h2>
					</a>
				</li>
				<li class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
					<a href="#">
						<div class="icon-img"><img src="<?php echo e(asset('public/img/triditional-programs-icon-6.png')); ?>" alt="icon-6"></div>
						<h2>AIRFARE</h2>
					</a>
				</li>
				<li class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
					<a href="#">
						<div class="icon-img"><img src="<?php echo e(asset('public/img/triditional-programs-icon-7.png')); ?>" alt="icon-7"></div>
						<h2>TIME OFF WORK</h2>
					</a>
				</li>
				<li class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
					<a href="#">
						<div class="icon-img"><img src="<?php echo e(asset('public/img/triditional-programs-icon-8.png')); ?>" alt="icon-8"></div>
						<h2>ROOM & BOARD</h2>
					</a>
				</li>
			</ul>
	...
	<div class="start-learning-today col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="slider-center-button new-bottom-button">
			<a href="<?php echo e(route('allCourses')); ?>">Start Learning Today</a>
		</div>
	</div>
</section>
