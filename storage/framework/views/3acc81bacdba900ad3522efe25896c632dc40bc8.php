...
<head>
   ...
   <link rel="stylesheet" href="<?php echo e(asset('public/css/bootstrap.min.css')); ?>"> 
    ...
    <link href="<?php echo e(asset('public/css/style.css')); ?>?v=<?php echo time();?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('public/css/emoji.css')); ?>">
    <link href="<?php echo e(asset('public/css/custom.css')); ?>?v=<?php echo time();?>" rel="stylesheet">
